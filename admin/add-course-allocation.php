...
if (isset($_POST['submit'])) {
 $crud->insertCourseAllocation($_POST['course']);
}

$lecturer=$crud->displayAll('lecturer');
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Add Course Allocation</a></li>
                ...
                <div class="col-md-12">
                        <div class="card">
                            <div class="card-title">
                                <h4>ADD COURSE ALLOCATION</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="add-course-allocation.php" method="POST">
                                          ...
                                          <div class="form-group">
                                                ...
                                                <select class="form-control input-rounded" name="lecturer_id"  required="required">
                                                    <?php foreach ($lecturer as $s) { ?>
                                                     <option value="<?=$s['id']?>"><?php echo strtoupper($s['name']);?> (<?=strtoupper($crud->displayNameById('department',$s['department_id']))?> DEPARTMENT)</option>
                                                 <?php  } ?>
                                             </select>
                                         </div>
                                       
                                          <div class="form-group">
                                                <p class="text-muted m-b-15 f-s-12">Allocate Course :</p>
