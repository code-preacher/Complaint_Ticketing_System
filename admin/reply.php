...
if (isset($_POST['sub'])) {
 $crud->AdminComplainG($_POST);
}

$reply=$crud->displayAllSpecificWithOrder3('complain_g','sender',$_GET['matno'],'reciever',$_GET['matno'],'id','desc');
?>
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Reply Complain</a></li>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <form action="#" role="form" method="POST">
                                                ...
                                                <div class="form-group">
                                                    <textarea name="reply" rows="8" cols="80" class="form-control" style="height:100px">
                                                    </textarea>

                                                    <input type="hidden" name="matno" value="<?=$_GET['matno']?>">
